...
$inputDirectory = "C:\temp\awards\in"  # Change this to your directory
...
foreach ($csvFile in $csvFiles) {
    ...
    while (-not $streamReader.EndOfStream) {
        ...
        foreach ($line in $batchLines) {
            ...
            Write-Host $record["product_or_service_code"]
    ...
    if ($filteredData.Count -eq 0) {
        ...
        $filteredData | Select-Object -Property $columns | Export-Csv -Path $outputFilePath -NoTypeInformation
